...
class BuildPyWithTorchVersion(build_py):
    def run(self):
        _write_build_info()
        super().run()


class BuildExtensionWithTorchVersion(BuildExtension):
    def run(self):
        _write_build_info()
        super().run()
...
setup(
    ...
    cmdclass={
        "build_py": BuildPyWithTorchVersion,
        "build_ext": BuildExtensionWithTorchVersion,
    },
)
